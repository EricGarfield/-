...
- (void)viewDidLoad {
    ...
    self.view.layer.borderColor = (__bridge CGColorRef _Nullable)([UIColor lightGrayColor]);
}
...
- (void)layoutSubviews {
    ...
    self.headerView.backgroundColor = [UIColor colorWithRed:145/255.0 green:187/255.0 blue:255/255.0 alpha:1.0];
...
//    CGRectMake(0, kHeaderViewHeight, SCREEN_SIZE.width, SCREEN_SIZE.height - kHeaderViewHeight)
    ...
    self.tableView.backgroundColor = [UIColor colorWithRed:145/255.0 green:187/255.0 blue:255/255.0 alpha:1.0];
    //* 隐藏滚动条 */
    self.tableView.showsVerticalScrollIndicator = NO;
    
    self.newsBooksLabel = [UILabel new];
    self.newsBooksLabel.text = @"账单";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.backgroundColor = [UIColor colorWithRed:145/255.0 green:187/255.0 blue:255/255.0 alpha:1.0];
