...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor colorWithRed:119/255.0 green:196/255.0 blue:235/255.0 alpha:1.0];
...
- (void)layoutSubviews {
    ...
    self.headerView.backgroundColor = [UIColor colorWithRed:119/255.0 green:196/255.0 blue:235/255.0 alpha:1.0];
    ...
    flowLayout.itemSize = CGSizeMake(width/3, height/3 - 20);
    ...
    self.collectionView.backgroundColor = [UIColor colorWithRed:119/255.0 green:196/255.0 blue:235/255.0 alpha:1.0];
